...
\institute{\textbf{\textcolor{black}{Swinburne University of Technology Sarawak \\[0.1cm] 
Bachelor of Engineering (Robotics and Mechatronics) (Honours) \\[0.1cm]
Supervisor:\ Dr.\ Evon Wan Ting Lim, Co-Supervisor: Ir.\ Chai Pui Ching}}}
\date{27th May 2025}
...
\begin{frame}{System Architecture}
	\begin{figure}
		\centering
		\includegraphics[width=0.9\textwidth]{images/Simulation_Architecture.png}
...
\begin{column}{0.45\textwidth}
  \begin{figure}
    \includegraphics[width=0.2\textwidth]{images/uml_state_diagram.png}
...
\begin{frame}{Software Tool Features}
		...
		\begin{columns}
			\begin{column}{0.4\textwidth}
				\centering
					\includegraphics[width=0.15\textwidth]{images/jazzy-small.png}\\
        {\reducefontsize%
        \centering
			...
			\begin{column}{0.4\textwidth}
				\centering
					\includegraphics[width=0.15\textwidth]{images/qt_logo.png}\\
				{\reducefontsize%
        \centering 
		...
		\begin{columns}
			\begin{column}{0.3\textwidth}
				\centering
					\includegraphics[width=0.15\textwidth]{images/gazebo_logo.png}\\
        {\reducefontsize%
        \centering
      ...
      \begin{column}{0.3\textwidth}
				\centering
					\includegraphics[width=0.15\textwidth]{images/rviz_logo.png}\\
        {\reducefontsize%
        \centering
...
\begin{frame}{Robot Model}
	...
	\begin{columns}
      ...
      {\reducefontsize%
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.5\textwidth]{images/uml_event_flow.png}
      ...
      {\reducefontsize%
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.5\textwidth]{images/uml_state_diagram.png}
      ...
      \hspace{-1em}
        ...
        \setlength{\fboxrule}{1.2pt}
				\fbox{
					\begin{minipage}{0.6\textwidth}
						{\centering
              \underline{\textbf{Assembly}}\\[0.25em]
                  }
						$\sim$ 4 hours of wiring/soldering\\
						$\sim$ 40 minutes of assembly\\
						\textbf{$\sim$ 4 hour 40 min total}
        ...
        \setlength{\fboxrule}{1.2pt}
				\fbox{
					\begin{minipage}{0.6\textwidth}
						{\centering
							\underline{\textbf{Manufacturing}}\\[0.25em]
						}
						%$\vspace{-0.2em}
						$\sim$ 20 minutes of laser cutting\\
						$\sim$ 8 hours of 3D printing\\
